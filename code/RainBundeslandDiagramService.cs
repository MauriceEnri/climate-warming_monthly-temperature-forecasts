...
public class RainBundeslandDiagramService
{
    public void Create(Dictionary<string, List<(DateTime date, double daily, double cum)>> series)
    {
        ...
        {
            Title = $"Fortlaufender Niederschlag – Bundesländer {startDate:dd.MM} – {endDate:dd.MM}",
            TitleFont = "Segoe UI Semibold",
            TitleFontSize = 24,
            Background = OxyColors.White,
            TextColor = OxyColors.Black,
            PlotAreaBorderColor = OxyColors.Transparent,
            Padding = new OxyThickness(10, 10, 140, 10)
        };
        ...
        var palette = new[]
        {
            OxyColors.Blue, OxyColors.DarkBlue, OxyColors.SkyBlue, OxyColors.CadetBlue,
            OxyColors.SteelBlue, OxyColors.CornflowerBlue, OxyColors.MediumBlue, OxyColors.RoyalBlue,
            OxyColors.LightBlue, OxyColors.Teal, OxyColors.DarkCyan, OxyColors.SlateBlue,
            OxyColors.DodgerBlue, OxyColors.DeepSkyBlue, OxyColors.Navy, OxyColors.MidnightBlue
        };
        ...
        Directory.CreateDirectory("output/diagramme/bundesland/rain");

        using var stream = File.Create("output/diagramme/bundesland/rain/bundeslaender_rain.png");
